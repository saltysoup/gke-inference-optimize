...
export NODEPOOL_NAME="h200-ccc"
export ACCELERATOR_TYPE="nvidia-h200-141gb"
...
# 8 x H200 nodepool
  ...
  --node-labels="cloud.google.com/compute-class=h200-ccc" \
  --node-taints="cloud.google.com/compute-class=h200-ccc:NoSchedule"

# Authenticate with cluster
gcloud container clusters get-credentials $CLUSTER_NAME --location=$REGION

# Set up CCC
kubectl apply -f h200-ccc.yaml
